...
namespace Persistance.Migrations
{
    ...
    [Migration("20240206161519_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ITWarehouse.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.ITWarehouse.Item_Note", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.ITWarehouse.Employee", b =>
                {
                    b.HasOne("Domain.Entities.ITWarehouse.Employee", "Manager")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.ITWarehouse.Item", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ITWarehouse.State", "State")
                        .WithMany()
                        .HasForeignKey("StateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.ITWarehouse.Warehouse", "Warehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.ITWarehouse.Item_Note", b =>
                {
                    b.HasOne("Domain.Entities.ITWarehouse.Item", "item")
                        .WithMany()
