    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Items_Notes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Items_Notes_Items_itemId",
                        column: x => x.itemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Items_Notes_Notes_noteId",
                        column: x => x.noteId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_Notes_itemId",
                table: "Items_Notes",
                column: "itemId");

            migrationBuilder.CreateIndex(
                name: "IX_Items_Notes_noteId",
                table: "Items_Notes",
                column: "noteId");
