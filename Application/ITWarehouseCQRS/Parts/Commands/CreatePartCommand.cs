...
public class CreatePartCommand : IRequest<int>
{
    ...
    public CreatePartCommand(string name, CategoryVm categoryVm, VendorVm vendorVm, string description, string photo, int warrantyPeriod, bool iscurrentlyOrderable)
    {
        Name = name;
